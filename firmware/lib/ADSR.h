...
--|         ADSR_INPUT_TYPE_RELEASE_TIME_mSec
--|
--|     float current_value: the current value of the ADSR, range [0.0, 1.0].
--|
--|     uint32_t accumulator: handled privately.
--|     uint32_t last_accumulator_value: handled privately.
--|     float value_when_gate_on_recieved: handled privately.
--|     float value_when_gate_off_recieved: handled privately.
--|
