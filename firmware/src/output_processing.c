...
void update_MCP4822_DACs(void)
{
    ...
    MCP4822_Write(SPI3_DAC1_CS_GPIO_Port, SPI3_DAC1_CS_Pin, MCP4822_CHANNEL_B, MCP4822_GAIN_1x, adsr[0].current_value * MCP4822_FULL_SCALE);
    MCP4822_Write(SPI3_DAC1_CS_GPIO_Port, SPI3_DAC1_CS_Pin, MCP4822_CHANNEL_A, MCP4822_GAIN_1x, adsr[1].current_value * MCP4822_FULL_SCALE);
    MCP4822_Write(SPI3_DAC2_CS_GPIO_Port, SPI3_DAC2_CS_Pin, MCP4822_CHANNEL_B, MCP4822_GAIN_1x, adsr[2].current_value * MCP4822_FULL_SCALE);
    MCP4822_Write(SPI3_DAC2_CS_GPIO_Port, SPI3_DAC2_CS_Pin, MCP4822_CHANNEL_A, MCP4822_GAIN_1x, adsr[3].current_value * MCP4822_FULL_SCALE);
}
